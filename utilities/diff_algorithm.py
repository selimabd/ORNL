...
def calculate_jumps(t, ydiff, x2, x, y=None, method=1):
    '''
    ...
    if method == 2:
        return calculate_jumps_method_1(t, y, x2, x, jumps)
    else:    
        return calculate_jumps_method_1(t, ydiff, x2, x, jumps)

    
def calculate_jumps_method_1(t, ydiff, x2, x, jumps):
...
def calculate_jumps_method_2(t, ydiff, x2, jumps):
